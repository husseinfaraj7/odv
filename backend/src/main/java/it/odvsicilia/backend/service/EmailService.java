...
public class EmailService {
        ...
        return String.format("""
            ...
            <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                    ...
                    <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
                        <h3 style="color: #2c5530; margin-top: 0;">Dettagli dell'Ordine:</h3>
                    ...
                    <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
                        <p style="color: #666; font-size: 14px;">
                            Ordine generato automaticamente dal sito web ODV Sicilia
                        </p>
                    </div>
                </div>
            </body>
                ...
                <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                    ...
                    <div style="background-color: #e8f4f8; padding: 15px; border-radius: 8px; margin: 20px 0;">
                        <p style="margin: 0; color: #2c5530;">
                            ...
                            Ti contatteremo presto per confermare i dettagli e coordinarci per la consegna.
                        </p>
                    </div>
    ...
    private void validateRecipientEmail(String email) {
        ...
        try {
            ...
            throw new EmailInvalidRecipientException("Email destinatario non valida: " + email, "RECIPIENT_EMAIL_INVALID", e);
        }
    }
}