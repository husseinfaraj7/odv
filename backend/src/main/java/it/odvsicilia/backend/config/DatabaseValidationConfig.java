...
public class DatabaseValidationConfig implements InitializingBean {
    ...
    private String detectAndEncodeSpecialCharacters(String databaseUrl) {
        ...
        try {
            ...
            // Encode the password using standard Java URLEncoder
    ...
    private void handleEncodingError(String databaseUrl, URISyntaxException e, String operation, int errorIndex) {
        ...
        String detailedMessage = String.format(
            ...
            "SOLUTION: Use standard Java URLEncoder for automatic URL encoding!\n" +
            "Example usage:\n" +
            "  String encodedPassword = URLEncoder.encode(\"P@ssw0rd#123\", StandardCharsets.UTF_8);\n" +
            ...
            "2. URL-encode them using the mappings above or use URLEncoder.encode()\n" +
