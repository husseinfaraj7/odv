...
public class RenderDeploymentSimulationTest {
    ...
    private final org.springframework.boot.test.web.server.LocalServerPort port;
    private final DataSource dataSource;

    public RenderDeploymentSimulationTest(@org.springframework.boot.test.web.server.LocalServerPort int port,
