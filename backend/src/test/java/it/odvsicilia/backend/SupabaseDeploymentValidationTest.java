 ...
 * 1. Supabase database connectivity and CRUD operations
...
@ActiveProfiles("test")
public class SupabaseDeploymentValidationTest {
    ...
    public void testEnvironmentConfiguration() {
        ...
        if (System.getProperty("spring.profiles.active", "").contains("prod")) {
            ...
            assertTrue(databaseUrl.contains("postgres") && databaseUrl.contains("supabase.co"), 
    ...
    @Test
    @Order(2)
    public void testSupabaseDatabaseConnectivity() throws Exception {
        // Test Supabase database connection
        try (Connection connection = dataSource.getConnection()) {
            assertTrue(connection.isValid(5), "Supabase database connection should be valid");
            ...
            // Verify Supabase connection characteristics
            String jdbcUrl = metaData.getURL();
            if (System.getProperty("spring.profiles.active", "").contains("prod")) {
                assertTrue(jdbcUrl.contains("supabase.co") || jdbcUrl.contains("localhost"), 
                    "Production should connect to Supabase or local database");
            }
            ...
            assertTrue(contactMessagesTableExists, "ContactMessage table should exist in Supabase");
            assertTrue(ordersTableExists, "Orders table should exist in Supabase");
        }
        
        System.out.println("✅ Supabase Database Connectivity Test Passed");
    }

    @Test
    @Order(3)
    public void testSupabaseDatabaseCRUDOperations() {
        // Test Contact Message CRUD with Supabase
        ...
        testContact.setName("Test User - Supabase");
        testContact.setEmail("test@supabase.example.com");
        testContact.setSubject("Supabase Test Subject");
        testContact.setMessage("Test message for Supabase deployment validation");
        ...
        // Verify contact was saved to Supabase
        long finalContactCount = contactMessageRepository.count();
        assertEquals(initialContactCount + 1, finalContactCount);
        
        // Test Order CRUD with Supabase
        long initialOrderCount = orderRepository.count();
        
        // Create test order
        OrderDto testOrder = new OrderDto();
        testOrder.setCustomerName("Supabase Test Customer");
        testOrder.setCustomerEmail("customer@supabase.example.com");
        testOrder.setCustomerPhone("0987654321");
        testOrder.setShippingAddress("Supabase Test Address");
        ...
        orderItem.setProductName("Test Oil - Supabase");
        ...
        // Verify order was saved to Supabase
        long finalOrderCount = orderRepository.count();
        assertEquals(initialOrderCount + 1, finalOrderCount);
        
        System.out.println("✅ Supabase Database CRUD Operations Test Passed");
    }
    ...
    @Test
    @Order(7)
    public void testSupabaseDataIntegrity() {
        // Test that data persists across requests in Supabase
        ...
        contact.setName("Supabase Integrity Test");
        contact.setEmail("integrity@supabase.test.com");
        contact.setSubject("Supabase Data Integrity Test");
        contact.setMessage("Testing data integrity with Supabase");
        ...
        System.out.println("✅ Supabase Data Integrity Test Passed");
    }

    @Test
    @Order(8)
    public void testSupabasePerformanceBaseline() {
        ...
        System.out.println("Average Supabase Response Time: " + averageResponseTime + "ms");
        
        // Basic performance assertion - responses should be under 2 seconds on average
        assertTrue(averageResponseTime < 2000, 
            "Average response time with Supabase should be under 2 seconds, was: " + averageResponseTime + "ms");
        
        System.out.println("✅ Supabase Performance Baseline Test Passed");
    }
}