...
public class BrevoConfigIntegrationTest {
    ...
    // TransactionalEmailsApi removed due to package structure changes in Brevo SDK 6.0.0
    ...
    class SdkIntegrationTests {
        ...
        public void testBrevoApiClientConfiguration() {
            ...
            // TransactionalEmailsApi removed due to package structure changes in Brevo SDK 6.0.0
            // EmailService handles email functionality directly via SMTP
        }

        @Test
        @DisplayName("Should validate sendinblue package structure")
        public void testPackageStructureIntegration() {
            ...
            // Test that we can create API request objects (part of sendinblue.model package)
        ...
        @Test
        @DisplayName("Should create valid email request objects using sendinblue.model classes")
        public void testSendinblueModelIntegration() {
            // Test creating a complete email request using sendinblue.model classes
